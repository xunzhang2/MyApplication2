...
//                   cursor = dbRead.query("cities",null,null,null,null,null,null);
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getSupportFragmentManager().beginTransaction().add(R.id.frag, blankFragment).commit();
            }
        });
    }
